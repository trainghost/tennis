...
def members():
    ...
    if request.method == 'POST':
        ...
        for idx, member in enumerate(members_data):
            ...
            if received_rank is not None and received_rank.isdigit():
        ...
        if len(participants_1) < 12:
            ...
            participants_1.extend(eligible_for_random[:needed])
        ...
        if summary_1['total'] == 12:
            ...
            if summary_1['female'] == 5 and summary_1['male'] == 7:
                ...
                team_match_results_1 = [
                    {'court': '3번 코트', 'team_a': [female_members_1[0], male_members_1[1]], 'team_b': [female_members_1[1], male_members_1[0]]}, # 여1, 남2 vs 여2, 남1
                    {'court': '4번 코트', 'team_a': [male_members_1[2], male_members_1[9]], 'team_b': [male_members_1[3], male_members_1[8]]}, # 남3, 남10 vs 남4, 남9
                    {'court': '5번 코트', 'team_a': [male_members_1[4], male_members_1[7]], 'team_b': [male_members_1[5], male_members_1[6]]}  # 남5, 남8 vs 남6, 남7
                ]
        ...
        # 매칭 3 대진표 (요청하신 image_76b0e9.png 반영)
        if summary_3['total'] == 12:
            ...
            if summary_3['female'] == 5 and summary_3['male'] == 7:
                ...
                # 이 부분을 요청하신 image_76b0e9.png 내용으로 업데이트합니다.
                team_match_results_3 = [
        ...
        if 'last_match_results' in session:
            ...
            members_data = last_results.get('members_data', [])
